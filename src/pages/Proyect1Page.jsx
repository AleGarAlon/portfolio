  ...
  return (
    <div className="proyect">
      ...
      <p className="description">
        This proyect is a game build in one page using DOM manipulation.
      </p>
      <div className="use">
      ...
      <a
        href="https://alegaralon.github.io/AssaultOnSomniumStars/"
        target="_blank"
        rel="noreferrer"
      >
        <img
          className="proyectPhoto"
          src={proyect1}
          alt="AssaultOnSomniumStars"
        />
      </a>
      ...
      <div className="links">
        ...
        <div className="linkIcons"></div>
        <a
          href="https://github.com/AleGarAlon/AssaultOnSomniumStars"
          target="_blank"
          rel="noreferrer"
        >
